...
### المادة 5: النهج المقدس في التصميم (Al-Manhaj Al-Muqaddas)
5.1. **مبدأ القداسة البصرية:** الواجهة يجب أن تكون نقية، مقدسة، وخالية من أي مشتتات. التركيز المطلق على الوظيفة الأساسية. الهوية البصرية تعتمد على قاعدة لونية داكنة وعميقة (`#05080F`, `#1F0A0D`) مع لمسة ذهبية مقدسة (`#CBA135`) تبرز العناصر الحيوية فقط.
5.2. **مبدأ النقاء الوظيفي:** كل عنصر في الشاشة يجب أن يخدم غرضاً واضحاً ومباشراً. يمنع منعاً باتاً استخدام أي زخارف أو عناصر بصرية لا تساهم في إنجاز المهمة. الوظيفة هي الجمال.
5.3. **قانون التفاعل الأول:** أول تفاعل للمستخدم مع الواجهة يجب أن يكون فورياً، بديهياً، وساحقاً في بساطته. الأزرار يجب أن تكون واضحة، والإجراء الأساسي المطلوب يجب أن يكون هو العنصر المهيمن في الشاشة.
5.4. **قانون السيادة الرقمية:** شاشة المستخدم هي أرضه الرقمية، والتطبيق هو ضيف عليها. يجب أن يكون محترماً، فعالاً، وألا يهدر مساحة المستخدم أو وقته.
